...
export default function TextListItem({ itemKey, itemValue, iconName, onPressE = null, processing= false }: { itemKey: string, itemValue: string | number, iconName?: string, onPressE?: any, processing?: boolean }) {
